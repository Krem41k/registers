...
/**
 * Provides the local service interface for JobDirectory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LiferaySavvy
 * @see JobDirectoryLocalServiceUtil
...
public interface JobDirectoryLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link JobDirectoryLocalServiceUtil} to access the job directory local service. Add custom service methods to {@link com.meera.db.service.impl.JobDirectoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
