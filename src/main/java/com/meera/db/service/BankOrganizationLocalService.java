...
/**
 * Provides the local service interface for BankOrganization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LiferaySavvy
 * @see BankOrganizationLocalServiceUtil
...
public interface BankOrganizationLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BankOrganizationLocalServiceUtil} to access the bank organization local service. Add custom service methods to {@link com.meera.db.service.impl.BankOrganizationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
