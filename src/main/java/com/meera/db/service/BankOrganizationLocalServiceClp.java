 ...
 * @generated
 */
public class BankOrganizationLocalServiceClp
    ...
    public BankOrganizationLocalServiceClp(
    ...
    public com.meera.db.model.BankOrganization addBankOrganization(
        ...
        return (com.meera.db.model.BankOrganization) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.meera.db.model.BankOrganization createBankOrganization(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { bankOrganizationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.meera.db.model.BankOrganization deleteBankOrganization(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { bankOrganizationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.meera.db.model.BankOrganization fetchBankOrganization(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { bankOrganizationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.meera.db.model.BankOrganization getBankOrganization(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { bankOrganizationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.meera.db.model.BankOrganization> getBankOrganizations(
        ...
        return (java.util.List<com.meera.db.model.BankOrganization>) ClpSerializer.translateOutput(returnObj);
    }
